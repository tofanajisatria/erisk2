...
<?= $this->session->flashdata('message'); ?>
        ...
        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addNewSubMenu"> Add New Menu</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addNewMenuLabel">Add New Sub Menu</h5>
